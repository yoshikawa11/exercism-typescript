...
import { verse, verses } from "../answers/foodChain.ts";
...
I don't know why she swallowed the fly. Perhaps she'll die.
`;
  assertEquals(verses(1, 2), expected);
});

Deno.test("the whole song", () => {
  const expected = `I know an old lady who swallowed a fly.
I don't know why she swallowed the fly. Perhaps she'll die.
...
She's dead, of course!
`;
  assertEquals(verses(1, 8), expected);
});
